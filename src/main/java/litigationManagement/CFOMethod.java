...
//			performerPOM.selectAgeFiltercfo(driver).click();
		...
		public static void CaseNoticeTypeGraph1(WebDriver driver, ExtentTest test, String type,int countType ) throws InterruptedException, IOException
		{
			...
			{
				Thread.sleep(3000);
		        performerPOM.CaseNoticeTypeApplicant2(driver).click();						//Clicking on 'Open' notice
			}
			else if(type.equalsIgnoreCase("Respondent Type"))
			{
				Thread.sleep(2000);
			...
			{
				Thread.sleep(2000);
		        performerPOM.CaseNoticeTypeOutwardPlaintiff2(driver).click();						//Clicking on 'Open' notice
			}
		 ...
		 public static void TaskActivity1(WebDriver driver, ExtentTest test,XSSFWorkbook workbook ) throws InterruptedException, IOException
			{
		       ...
		       Thread.sleep(500);
			    ...
			    Thread.sleep(5000);
			    performerPOM.clickHearingDate(driver).sendKeys("01-08-2024");
...
//					performerPOM.clickCaseHearingDate(driver).sendKeys(HearingDate+"");	//Writing 'HearingDate'
					...
					performerPOM.clickCaseHearingDate(driver).sendKeys("10-05-2024");	//Writing 'HearingDate'
			...
			public static void CaseOrder(WebDriver driver, ExtentTest test, XSSFWorkbook workbook) throws InterruptedException, IOException
			{
				WebDriverWait wait=new WebDriverWait(driver,20);
				 ...
				 Thread.sleep(6000);
				 performerPOM. clickCaseOrderDate(driver).sendKeys("30-04-2023");
				 Thread.sleep(3000);
...
//						
					...
					public static void CloseNoticeCase(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String type) throws InterruptedException, IOException
					{
						...
						else if(type.equals("Task"))
						{
							...
							Thread.sleep(4000);
							performerPOM.clickSearchFilterworkspace(driver).sendKeys("CFO Finance");
							Thread.sleep(4000);
...
//						
					...
					static void NewReminder(WebDriver driver, ExtentTest test, String type) throws InterruptedException
					{
						...
						Thread.sleep(3000);
						performerPOM.clickReminderText(driver).sendKeys("Reminder new 8Mar24");
						
						Thread.sleep(3000);
						performerPOM.clickDescription(driver).sendKeys("Reminder new 8Mar24");
...
//						action.moveToElement(performerPOM.clickTitle(driver)).click().sendKeys(Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ENTER).perform();
						...
						Thread.sleep(3000);
						performerPOM.clickReminderText(driver).sendKeys("Reminder  new 14march2024");
						
						Thread.sleep(3000);
						performerPOM.clickDescription(driver).clear();
						
						Thread.sleep(3000);
						performerPOM.clickDescription(driver).sendKeys("Reminder new 14march2024");
...
//							    robot.keyPress(KeyEvent.VK_CONTROL);
							...
							WebElement text=driver.findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[15]/a"));
							if(text.isEnabled())
							{
								driver.findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[15]/a")).click();
            ...
            public static void InwardDefendantAgeingGraph(WebDriver driver,ExtentTest test, String type) throws InterruptedException, IOException
          		
          		{
          			...
          			performerPOM.clickDashboardNoticeFilter(driver).click();
          			 ...
          			 Thread.sleep(5000);
          	       	...
          	       	int	open = Integer.parseInt(performerPOM.clickAgeing(driver).getText());	//Reading Notice Open count.
 		 ...
 		 public static void CaseExistingHearingData(WebDriver driver, ExtentTest test, XSSFWorkbook workbook) throws InterruptedException, IOException
			{
				   ...
				   wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("showdetails"));
					...
					performerPOM.clickNewCaseHearing(driver).click();
					Thread.sleep(3000);
                	performerPOM.clickCaseHearingDate(driver).sendKeys("28-06-2023");	//Writing 'HearingDate'
				    Thread.sleep(3000);
				    performerPOM.clickSaveCaseHearingDate(driver).click();
				...
				public static void CaseNoticeTypeFilter(WebDriver driver, ExtentTest test,String type) throws InterruptedException
				{
					...
					JavascriptExecutor js = (JavascriptExecutor) driver;
			     	...
			     	if(type.equalsIgnoreCase("CaseNoticeTypeSummaryGraph"))
			     	{
			     		js.executeScript("window.scrollBy(0,800)");
			     	  Thread.sleep(2000);
			          performerPOM.CaseNoticeTypeOutwardPlaintiff(driver).click();
			     	}
			     	...
			     	else if(type.equalsIgnoreCase("DepartmentSummaryGraph"))
			     	{
			     		js.executeScript("window.scrollBy(0,2000)");
				     	Thread.sleep(2000);
				     	performerPOM.DepartmentSummaryGraph1(driver).click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
			    	...
			    	else if(type.equalsIgnoreCase("LocationSummaryGraph"))
			     	{
				     	...
				     	Thread.sleep(2000);
				     	performerPOM.LocationSummaryGraph(driver).click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
...
//								{
				...
				public static void AgeingGraphFilter(WebDriver driver, ExtentTest test,String type) throws InterruptedException
				{
					...
					JavascriptExecutor js = (JavascriptExecutor) driver;
			     	...
			     	if(type.equalsIgnoreCase("Inward/Defendent"))
			     	{
			     	  ...
			     	  Thread.sleep(3000);
			          performerPOM.clickAgeing(driver).click();
			     	}
			     	else if(type.equalsIgnoreCase("Complainant"))
			     	{
			     	
			     	  Thread.sleep(2000);
			          performerPOM.clickComplainantAgeing(driver).click();
			     	}
			     	...
			     	else if(type.equalsIgnoreCase("Outward/Plaintiff"))
			     	{
				     	...
				     	Thread.sleep(2000);
				     	performerPOM.clickOutwardPlaintiffAgeing(driver).click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
			    	...
			    	else if(type.equalsIgnoreCase("Petitioner"))
			     	{
				     	...
				     	Thread.sleep(2000);
				     	performerPOM.clickPetitionerAgeing(driver).click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
			     	}      
			    	else if(type.equalsIgnoreCase("Respondent"))
			     	{
			     		
				     	Thread.sleep(2000);
				     	performerPOM.clickRespondentAgeing(driver).click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
			     	}      
			        Thread.sleep(2000);
					wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("showChartDetails"));
...
//								{
				...
				public static void AgeingGraph1to2Filter(WebDriver driver, ExtentTest test,String type) throws InterruptedException
				{
					...
					JavascriptExecutor js = (JavascriptExecutor) driver;
			     	...
			     	if(type.equalsIgnoreCase("Complianant"))
			     	{
			     	  ...
			     	  Thread.sleep(2000);
			          performerPOM.clickComplianant2(driver).click();
			     	}
			     	else if(type.equalsIgnoreCase("Inward/Defendent"))
			     	{
			     	
			     	  Thread.sleep(2000);
			          performerPOM.clickComplianant1(driver).click();
			     	}
			     	else if(type.equalsIgnoreCase("Outward/Plaintiff"))
			     	{
		 		 ...
		 		 public static void ClosedCaseDoc(WebDriver driver, ExtentTest test) throws InterruptedException, IOException
		 		{
		 			...
		 			//--------------------------------Case----------------------------------
				       ...
				       performerPOM.clickFilter2(driver).click();
				        ...
				        Thread.sleep(8000);
				       performerPOM.clickSearchFilterworkspace(driver).sendKeys("15052024");
