    ...
    public static void Response(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
			{
			   ...
			   wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("showdetails"));
	                ...
	                Thread.sleep(500);
	                 Row row4 = sheet.getRow(35);								//Selected 0th index row (First row)
		...
		WebDriverWait wait = new WebDriverWait(driver, 60);
		 ...
		 Thread.sleep(3000);
		  ...
		  Thread.sleep(3000);
		   ...
		   performerPOM.clickCriteria(driver).sendKeys(" Automation Rating");
		   Thread.sleep(3000);
	 ...
	 public  static void clickCaseInternalUser(WebDriver driver) throws InterruptedException 
   	...
   	public static void Document(WebDriver driver,ExtentTest test) throws InterruptedException
		...
		public static void TaskActivity1(WebDriver driver, ExtentTest test, XSSFWorkbook workbook,String login) throws InterruptedException, IOException
		{
		    ...
		    Thread.sleep(5000);
		    performerPOM.clickHearingDate(driver).sendKeys("08-11-2023");
		    Thread.sleep(300);
...
//			js.executeScript("window.scrollBy(0,200)");
			...
			Thread.sleep(1000);
			 row0 = sheet.getRow(29);									//Selected 0th index row (First row)
			 c1 = row0.getCell(1);									//Selected cell (0 row,1 column)
			String outcome1 = c1.getStringCellValue();
			performerPOM.clickExpOutcome(driver).sendKeys(outcome1);	//Writing 'Expected Outcome'
			...
			row0 = sheet.getRow(31);									//Selected 0th index row (First row)
			c1 = row0.getCell(1);									//Selected cell (0 row,1 column)
			String externalUser1 = c1.getStringCellValue();
			try
			{
				Thread.sleep(300);
				performerPOM.clickExternalUser(driver).click();
				Thread.sleep(500);
				action.moveToElement(performerPOM.clickSearchExternalUser(driver)).sendKeys(externalUser1, Keys.ENTER).perform();
			}
			catch(Exception e)
			{
			...
			row0 = sheet.getRow(32);									//Selected 0th index row (First row)
			c1 = row0.getCell(1);									//Selected cell (0 row,1 column)
			String remark1 = c1.getStringCellValue();
			performerPOM.clickRemark(driver).sendKeys(remark1);		//Writing 'Remark'
...
//				
				performerPOM.clickCaseHearingDate(driver).sendKeys("23-12-2023");	//Writing 'HearingDate'
			    ...
			    Thread.sleep(3000);
			    performerPOM.clickCaseHearingDecsri(driver).sendKeys("Case Hearing 19 JUN 2023");		//Writing 'HearingDescription'
		...
		public static void CaseOrder(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException
		{
			...
			// driver.switchTo().parentFrame();
			 ...
			 Thread.sleep(3000);
			 performerPOM. clickCaseOrderDate(driver).sendKeys("25-05-2023");
			 Thread.sleep(3000);
...
//		  performerPOM.clickMastersMenu(driver).click();
		  ...
		  Thread.sleep(3000);
		    ...
		    if(msg1.equalsIgnoreCase("Page Authorization Saved Successfully.")) 
		    {
...

{
	...
	JavascriptExecutor js = (JavascriptExecutor) driver;
		...
		{
			Thread.sleep(3000);
	        performerPOM.clickPetitionerCA1To2Years(driver).click();						//Clicking on 'Open' notice
		}
		else if(type.equalsIgnoreCase("Petitioner"))
		{
			Thread.sleep(3000);
		...
		{
		  Thread.sleep(3000);
          performerPOM.clickRespondentCA1To2Years(driver).click();						//Clicking on 'Open' notice
		}
	...
	public static void NoticeDocumentSearchFields(WebDriver driver, ExtentTest test) throws InterruptedException
    	{
 		WebDriverWait wait = new WebDriverWait(driver, 50);
			...
			Thread.sleep(3000);
			performerPOM.clickSearchDocument(driver).sendKeys("LitigationSheet.xlsx");
...
//							performerPOM.clickMinimize(driver).click();	
			 		...
			 		public static void CaseExistingHearingData(WebDriver driver, ExtentTest test) throws InterruptedException
			 		{
