	 ...
	 public  static void clickCaseInternalUser(WebDriver driver) throws InterruptedException 
   	...
   	public static void Document(WebDriver driver,ExtentTest test) throws InterruptedException
		...
		public static void TaskActivity1(WebDriver driver, ExtentTest test, XSSFWorkbook workbook,String login) throws InterruptedException, IOException
		{
		    ...
		    Thread.sleep(8000);
		    performerPOM.clickHearingDate(driver).sendKeys("01-03-2024");
		    Thread.sleep(8000);
...
//				
				performerPOM.clickCaseHearingDate(driver).sendKeys("20-02-2024");	//Writing 'HearingDate'
			    ...
			    Thread.sleep(8000);
			    performerPOM.clickCaseHearingDecsri(driver).sendKeys("Case Hearing 14Jan 2024");		//Writing 'HearingDescription'
		...
		public static void CaseOrder(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException
		{
			...
			// driver.switchTo().parentFrame();
			 ...
			 Thread.sleep(8000);
			 performerPOM. clickCaseOrderDate(driver).sendKeys("05-12-2023");
			 Thread.sleep(8000);
...
//		performerPOM.selectFromDate(driver).click();
	...
	static void NewReminder(WebDriver driver, ExtentTest test, String type) throws InterruptedException
	{
		...
		Thread.sleep(3000);
		performerPOM.clickReminderText(driver).sendKeys("Reminder as on date test 26Feb2024");
		
		Thread.sleep(3000);
		performerPOM.clickDescription(driver).sendKeys("Reminder as on date test 26Feb2024");
		
		Thread.sleep(3000);
		performerPOM.clickRemark2(driver).sendKeys("Reminder as on date test 26Feb2024");
...
//		}
		...
		Thread.sleep(3000);
		performerPOM.clickReminderText(driver).sendKeys("Reminder as on dated 1jan2024");
...
//						performerPOM.selectDocument(driver).click();	
					...
					public static void CriticalDocuments1(WebDriver driver, ExtentTest test) throws InterruptedException
					{
						...
						//Create Sub folder
							...
							Thread.sleep(1000);
							OverduePOM.writeFolderName(driver).sendKeys("Sub Document 9jan2024");			//Writing Folder name.
