	 ...
	 public  static void clickCaseInternalUser(WebDriver driver) throws InterruptedException 
   	...
   	public static void Document(WebDriver driver,ExtentTest test) throws InterruptedException
		...
		public static void TaskActivity1(WebDriver driver, ExtentTest test, XSSFWorkbook workbook,String login) throws InterruptedException, IOException
		{
		    ...
		    Thread.sleep(8000);
		    performerPOM.clickHearingDate(driver).sendKeys("27-04-2024");
		    Thread.sleep(8000);
...
//				
				performerPOM.clickCaseHearingDate(driver).sendKeys("03-04-2024");	//Writing 'HearingDate'
			    ...
			    Thread.sleep(8000);
			    performerPOM.clickCaseHearingDecsri(driver).sendKeys("Case Hearing 15Jan 2024");		//Writing 'HearingDescription'
		...
		public static void CaseOrder(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException
		{
			...
			// driver.switchTo().parentFrame();
			 ...
			 Thread.sleep(8000);
			 performerPOM. clickCaseOrderDate(driver).sendKeys("14-12-2023");
			 Thread.sleep(8000);
...
//		}
		...
		Thread.sleep(8000);
		performerPOM.clickReminderText(driver).sendKeys("Reminder as on dated 13jan2024");
