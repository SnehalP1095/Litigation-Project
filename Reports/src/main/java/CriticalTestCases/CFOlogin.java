...
void CaseNoticeTypeGraph() throws InterruptedException, IOException
{
	...
	int	Applicant = Integer.parseInt(performerPOM.CaseNoticeTypeApplicant1(driver).getText());	//Reading Notice Open count.
...
@Test(priority = 44)
	...
	void CategorySummaryGraph1() throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
			String CategoryName =performerPOM.CategoryName1(driver).getText();
	...
	void CaseOneToTwoYearGraph() throws InterruptedException, IOException
	{
		...
		Thread.sleep(3000);
		CFOMethod.CaseOneToTwoYearGraph(driver, test,"Inward/Defendent Type",InwardDefendent);
		Thread.sleep(3000);
		CFOMethod.CaseOneToTwoYearGraph(driver, test,"Outward/Plaintiff Type",OutwardPlaintiff);
		Thread.sleep(3000);
