...
//			performerPOM.selectAgeFiltercfo(driver).click();
		...
		public static void CaseNoticeTypeGraph(WebDriver driver, ExtentTest test, String type,int countType) throws InterruptedException, IOException
		{
			...
			{
				Thread.sleep(2000);
		        performerPOM.CaseNoticeTypeApplicant1(driver).click();						//Clicking on 'Open' notice
			}
		 ...
		 public static void TaskActivity1(WebDriver driver, ExtentTest test,XSSFWorkbook workbook ) throws InterruptedException, IOException
			{
		       ...
		       Thread.sleep(500);
			    ...
			    Thread.sleep(5000);
			    performerPOM.clickHearingDate(driver).sendKeys("31-07-2024");
...
//					performerPOM.clickCaseHearingDate(driver).sendKeys(HearingDate+"");	//Writing 'HearingDate'
					...
					performerPOM.clickCaseHearingDate(driver).sendKeys("08-05-2024");	//Writing 'HearingDate'
...
//						
					...
					static void NewReminder(WebDriver driver, ExtentTest test, String type) throws InterruptedException
					{
						...
						Thread.sleep(3000);
						performerPOM.clickReminderText(driver).sendKeys("Reminder new 5Mar24");
						
						Thread.sleep(3000);
						performerPOM.clickDescription(driver).sendKeys("Reminder new 5Mar24");
...
//							    robot.keyPress(KeyEvent.VK_CONTROL);
							...
							WebElement text=driver.findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[3]/a"));
							if(text.isEnabled())
							{
								driver.findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[3]/a")).click();
