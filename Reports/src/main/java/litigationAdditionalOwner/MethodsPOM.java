	 ...
	 public  static void clickCaseInternalUser(WebDriver driver) throws InterruptedException 
   	...
   	public static void Document(WebDriver driver,ExtentTest test) throws InterruptedException
		...
		public static void TaskActivity1(WebDriver driver, ExtentTest test, XSSFWorkbook workbook,String login) throws InterruptedException, IOException
		{
		    ...
		    Thread.sleep(8000);
		    performerPOM.clickHearingDate(driver).sendKeys("16-05-2024");
		    Thread.sleep(8000);
...
//				
				performerPOM.clickCaseHearingDate(driver).sendKeys("28-05-2024");	//Writing 'HearingDate'
		...
		public static void CaseOrder(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException
		{
			...
			// driver.switchTo().parentFrame();
			 ...
			 Thread.sleep(8000);
			 performerPOM. clickCaseOrderDate(driver).sendKeys("30-12-2023");
			 Thread.sleep(8000);
...
//		performerPOM.selectFromDate(driver).click();
	...
	static void NewReminder(WebDriver driver, ExtentTest test, String type) throws InterruptedException
	{
		...
		Thread.sleep(8000);
		performerPOM.clickReminderText(driver).sendKeys("Reminder as on date test 2mar2024");
		
		Thread.sleep(8000);
		performerPOM.clickDescription(driver).sendKeys("Reminder as on date test 2mar2024");
		
		Thread.sleep(8000);
		performerPOM.clickRemark2(driver).sendKeys("Reminder as on date test 2mar2024");
...
//		}
		...
		Thread.sleep(8000);
		performerPOM.clickReminderText(driver).sendKeys("Reminder as on dated 3jan2024");
